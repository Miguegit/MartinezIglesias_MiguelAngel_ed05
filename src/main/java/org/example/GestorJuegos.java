...
// Vendemos un juego con cantidad insuficiente
        cantidadVendida = tienda.venderJuego("ABC123", 20); // Debería mostrar unmensaje de error
        if (cantidadVendida > 0) {
            System.out.println("Se han vendido " + cantidadVendida + " juegos del código ABC123\n");
        } else {
...
//vendemos un juego con cantidad negativa
        cantidadVendida = tienda.venderJuego("ABC123", -2); // Debería mostrar unmensaje de error
        if (cantidadVendida > 0) {
            System.out.println("Se han vendido " + cantidadVendida + " juegos del código ABC123\n");
        } else {
            System.out.println("No se ha podido vender el juego con código ABC123\n");
...
//comprobamos que no se exceda el stock máximo
    ...
    /**
     * Método que vende una cantidad de juegos de un código específico. Devuelve
     la cantidad vendida o un código de error en caso de que no se pueda realizar la
     venta.
     * Códigos de error:
     ...
     * @return La cantidad de juegos vendidos o un código de error en caso de que
    no se pueda realizar la venta
     */
